...
-- ═══ 15. FREE ALUMNI RSVP ENTRY ═══════════════════════════════
-- /alumni is a free-entry RSVP, separate from merchandise orders. An
-- approved RSVP receives the same pass record the gate scanner already
-- understands; the pass is attached to either an order or a registration.
